...
- cc's self-report of which tool it used is not evidence. The architect's fold-check (ctrl+o on the collapsed call) is ground truth. Any instruction that hinges on tool choice is verified by expanding the fold, not by asking cc. (deploy7 filing §j, 2026-09-20)
