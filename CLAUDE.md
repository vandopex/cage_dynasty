...
- `claude/deploy_procedure.md` — disk-canonical deploy procedure v1; supersedes deploy5 §1 text; diff-driven ship-file hash gate against `git show newPA:path`, import-path gate from server.log (2026-09-18)
