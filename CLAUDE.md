...
- Champion injury Slices 2+ remain queued: Slice 2 (vacate-on-career, AI-driven top-2 fight for vacant belt), Slice 3 (player decision UX with dashboard prompt for Severe), Slice 4 (hold-path consequences — cardio decay, mandatory return defense, news tone progression), Slice 5 (interim belts + cleanup of vacate headline text), Slice 6 (ring rust + polish). See `memory/design_champion_injury_handling_2026-04-30.md`.
