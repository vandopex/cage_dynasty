...
- `claude/deploy6_2026-09-16.md` — Deploy #6 filing: FOUNDING-ROW2 to PA at 46c094f; 10/10 gates PASS with file-hash byte-identical proof; both owed browser checks closed one sitting (FOUNDING-ROW2 verified via streak boards; REMATCH-COOLDOWN1 verified via Tsarukyan vs Bailey CD62↔CD49 rematch); eight new dockets filed (BELT-LINEAGE1, RECAP-STALE1, HISTORY-CAP1, NAME-COLLISION1, DIVISION-GENDER1, HARNESS-ENV1, DUMP-PROVENANCE1, DRAW-SEMANTICS1 direction-corrected) (2026-09-16)
- `claude/handoff_post_deploy6.md` — post-deploy #6 handoff: anchors
  (no HEAD), one owed ruling, one landed correction, sequencing rec,
  cc-reading patterns, architect errors (2026-09-16)
