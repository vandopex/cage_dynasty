...
class FightConfig:
    ...
    Formula: (exchanges Ã— damage_mult Ã— 3 rounds) / health = ~0.60-0.65
    
    CURRENT: 65 Ã— 0.35 Ã— 3 = 68.25 / 120 = 0.57 ratio
    ...
    damage_multiplier: float = 0.70  # Allows knockdowns (need 12+ damage)
