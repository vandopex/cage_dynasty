...
COUNTRY_NAMES = {
    "United States": {
        "first": ["James", "John", "Robert", "Michael", "William", "David", "Richard", "Joseph", "Thomas", "Charles",
                  ...
                  "Nicholas", "Eric", "Jonathan", "Stephen", "Justin", "Scott", "Brandon", "Benjamin", "Samuel", "Gregory",
        ...
        "last": ["Smith", "Johnson", "Williams", "Brown", "Jones", "Garcia", "Miller", "Davis", "Rodriguez", "Martinez",
                 ...
                 "Wright", "Scott", "Hill", "Green", "Adams", "Nelson", "Baker", "Hall", "Rivera", "Campbell"]
    },
    "Brazil": {
        "first": ["Gabriel", "Lucas", "Matheus", "Pedro", "Guilherme", "Gustavo", "Rafael", "Felipe", "Joao", "Enzo",
                  "Vinicius", "Leonardo", "Thiago", "Arthur", "Eduardo", "Bruno", "Caio", "Daniel", "Igor", "Miguel",
                  "Ricardo", "Rodrigo", "Alexandre", "Marcelo", "Diego", "Leandro", "Renato", "Anderson", "Adriano", "Fabio"],
        "last": ["Silva", "Santos", "Oliveira", "Souza", "Rodrigues", "Ferreira", "Alves", "Pereira", "Lima", "Gomes",
                 "Costa", "Ribeiro", "Martins", "Carvalho", "Almeida", "Lopes", "Soares", "Fernandes", "Vieira", "Barbosa",
                 "Rocha", "Dias", "Nascimento", "Andrade", "Moreira", "Nunes", "Marques", "Machado", "Mendes", "Freitas"]
    },
    "Russia": {
        "first": ["Alexander", "Dmitri", "Ivan", "Sergei", "Mikhail", "Andrei", "Vladimir", "Alexei", "Nikolai", "Pavel",
                  "Viktor", "Oleg", "Igor", "Roman", "Maxim", "Artem", "Denis", "Konstantin", "Yuri", "Evgeni",
                  "Anatoli", "Grigori", "Stanislav", "Vasili", "Boris", "Timur", "Ruslan", "Kirill", "Ilya", "Anton"],
        "last": ["Ivanov", "Smirnov", "Kuznetsov", "Popov", "Volkov", "Petrov", "Sokolov", "Mikhailov", "Fedorov", "Morozov",
                 "Kozlov", "Lebedev", "Novikov", "Egorov", "Orlov", "Makarov", "Pavlov", "Bogdanov", "Belov", "Kovalev",
                 "Nurmagomedov", "Makhachev", "Ankalaev", "Chimaev", "Tsarukyan", "Evloev", "Khabibov", "Ismailov", "Abdulkadirov", "Gasanov"]
    },
    "United Kingdom": {
        "first": ["James", "Oliver", "Jack", "Harry", "George", "William", "Thomas", "Charlie", "Oscar", "Henry",
                  "Arthur", "Leo", "Alfie", "Noah", "Muhammad", "Archie", "Ethan", "Joshua", "Max", "Lucas"],
        "last": ["Smith", "Jones", "Williams", "Taylor", "Brown", "Davies", "Evans", "Wilson", "Thomas", "Roberts",
                 "Johnson", "Lewis", "Walker", "Robinson", "Wood", "Thompson", "White", "Watson", "Jackson", "Wright"]
    },
    "Canada": {
        "first": ["Liam", "Noah", "Oliver", "Lucas", "Leo", "Ethan", "Jack", "Benjamin", "Logan", "Alexander",
                  "William", "James", "Owen", "Daniel", "Ryan", "Nathan", "Jacob", "Michael", "Matthew", "Samuel"],
        "last": ["Smith", "Brown", "Tremblay", "Martin", "Roy", "Wilson", "MacDonald", "Taylor", "Campbell", "Anderson",
                 "Jones", "Williams", "Lee", "Johnson", "Thompson", "Gagnon", "White", "Scott", "Stewart", "Morrison"]
    },
    "Mexico": {
        "first": ["Santiago", "Mateo", "Sebastian", "Leonardo", "Diego", "Miguel", "Angel", "Daniel", "Carlos", "Jose",
                  "Luis", "Juan", "Pablo", "Alejandro", "Fernando", "Ricardo", "Jorge", "Francisco", "Eduardo", "Adrian"],
        "last": ["Garcia", "Rodriguez", "Martinez", "Lopez", "Hernandez", "Gonzalez", "Perez", "Sanchez", "Ramirez", "Torres",
                 "Flores", "Rivera", "Gomez", "Diaz", "Reyes", "Morales", "Jimenez", "Ruiz", "Vargas", "Mendoza"]
    },
    "Japan": {
        "first": ["Haruki", "Yuki", "Takeshi", "Kenji", "Hiroshi", "Kazuki", "Ryu", "Shinji", "Takanori", "Yoshihiro",
                  "Daiki", "Kenta", "Naoki", "Tatsuya", "Masahiro", "Akira", "Koji", "Tetsuo", "Hideo", "Noboru"],
        "last": ["Sato", "Suzuki", "Takahashi", "Tanaka", "Watanabe", "Ito", "Yamamoto", "Nakamura", "Kobayashi", "Kato",
                 "Yoshida", "Yamada", "Sasaki", "Yamaguchi", "Inoue", "Kimura", "Hayashi", "Shimizu", "Sakamoto", "Aoki"]
    },
    "South Korea": {
        "first": ["Min-jun", "Seo-jun", "Do-yun", "Ye-jun", "Si-woo", "Ha-jun", "Ji-hoon", "Jun-seo", "Hyun-woo", "Ji-won",
                  "Tae", "Doo", "Chan", "Jung", "Sung", "Seung", "Young", "Kyung", "Dong", "Jae"],
        "last": ["Kim", "Lee", "Park", "Choi", "Jeong", "Kang", "Jo", "Yoon", "Jang", "Lim",
                 "Han", "Oh", "Seo", "Shin", "Kwon", "Hwang", "Ahn", "Song", "Hong", "Yoo"]
    },
    "Australia": {
        "first": ["Oliver", "Jack", "Noah", "William", "Leo", "Henry", "Charlie", "Thomas", "Lucas", "Oscar",
                  "James", "Ethan", "Alexander", "Max", "Liam", "George", "Samuel", "Benjamin", "Daniel", "Ryan"],
        "last": ["Smith", "Jones", "Williams", "Brown", "Wilson", "Taylor", "Anderson", "Thomas", "Walker", "White",
                 "Thompson", "Johnson", "Martin", "Ryan", "Harris", "Lee", "King", "Hall", "Robinson", "Campbell"]
    },
    "Netherlands": {
        "first": ["Sem", "Finn", "Daan", "Lucas", "Levi", "Luuk", "Bram", "Max", "Jayden", "Noah",
                  "Milan", "Jesse", "Lars", "Tim", "Thomas", "Stefan", "Ruben", "Bas", "Stijn", "Joost"],
        "last": ["de Jong", "Jansen", "de Vries", "van den Berg", "van Dijk", "Bakker", "Janssen", "Visser", "Smit", "Meijer",
                 "de Graaf", "Mulder", "de Groot", "Bos", "Vos", "Peters", "Hendriks", "van Leeuwen", "Dekker", "Brouwer"]
    },
    "Poland": {
        "first": ["Antoni", "Jakub", "Jan", "Szymon", "Franciszek", "Filip", "Aleksander", "Mikołaj", "Wojciech", "Adam",
                  "Kacper", "Michał", "Marcel", "Leon", "Wiktor", "Stanisław", "Piotr", "Mateusz", "Bartosz", "Dawid"],
    ...
    "Nigeria": {
        "first": ["Chukwuemeka", "Oluwaseun", "Adebayo", "Chijioke", "Obinna", "Emeka", "Ikechukwu", "Chinedu", "Olumide", "Kayode",
                  "Tunde", "Adekunle", "Babatunde", "Yusuf", "Abubakar", "Ibrahim", "Abdul", "Usman", "Israel", "Kamaru"],
        "last": ["Adesanya", "Usman", "Okonkwo", "Okafor", "Obiora", "Nwankwo", "Eze", "Igwe", "Onyeka", "Obi",
                 "Adeyemi", "Adeleke", "Adeniyi", "Adenuga", "Bakare", "Bankole", "Fasanya", "Oyelaran", "Oyeniyi", "Ogundele"]
    },
    "Thailand": {
        "first": ["Nattawut", "Petchpanomrung", "Yodwicha", "Saenchai", "Buakaw", "Sitthichai", "Superbon", "Tawanchai", "Rodtang", "Panpayak",
                  "Thanonchai", "Somrak", "Worawut", "Pornsanae", "Saiyok", "Petchtanong", "Singdam", "Prajanchai", "Aikpracha", "Suakim"],
        "last": ["Petchyindee", "Sitsongpeenong", "Fairtex", "Banchamek", "Kiatmoo9", "Sitjaopho", "Sor Rawee", "PK Saenchai", "Elite", "Jitmuangnon"]
    },
    "China": {
        "first": ["Wei", "Jian", "Feng", "Li", "Song", "Hu", "Xie", "Liang", "Wang", "Zhang",
                  "Chen", "Yang", "Zhao", "Liu", "Guo", "Zhou", "Wu", "Xu", "Sun", "Ma"],
        "last": ["Wang", "Li", "Zhang", "Liu", "Chen", "Yang", "Zhao", "Huang", "Zhou", "Wu",
                 "Xu", "Sun", "Hu", "Guo", "Ma", "Zhu", "Gao", "Lin", "He", "Luo"]
    },
    "Sweden": {
        "first": ["Lucas", "Liam", "William", "Elias", "Noah", "Hugo", "Oliver", "Oscar", "Adam", "Matteo",
                  "Alexander", "Viktor", "Erik", "Gustav", "Filip", "Axel", "Emil", "Anton", "Leo", "Isak"],
    ...
    "France": {
        "first": ["Gabriel", "Leo", "Raphael", "Louis", "Lucas", "Hugo", "Adam", "Jules", "Arthur", "Nathan",
                  "Mathis", "Ethan", "Noah", "Tom", "Theo", "Enzo", "Maxime", "Paul", "Antoine", "Alexandre"],
        "last": ["Martin", "Bernard", "Dubois", "Thomas", "Robert", "Richard", "Petit", "Durand", "Leroy", "Moreau",
                 "Simon", "Laurent", "Lefebvre", "Michel", "Garcia", "David", "Bertrand", "Roux", "Vincent", "Fournier"]
    },
    "Ireland": {
        "first": ["Jack", "James", "Noah", "Conor", "Daniel", "Luke", "Sean", "Adam", "Harry", "Liam",
                  "Michael", "Charlie", "Fionn", "Cian", "Oisin", "Patrick", "Ryan", "Dylan", "Aaron", "Darragh"],
    ...
    "New Zealand": {
        "first": ["Oliver", "Jack", "Leo", "Lucas", "Liam", "Noah", "Charlie", "George", "William", "James",
                  "Hunter", "Mason", "Cooper", "Theo", "Archie", "Max", "Thomas", "Oscar", "Finn", "Henry"],
        "last": ["Smith", "Williams", "Brown", "Wilson", "Taylor", "Anderson", "Thomas", "Walker", "Harris", "King",
                 "Martin", "Thompson", "White", "Lee", "Jones", "Robinson", "Mitchell", "Campbell", "Davis", "Clark"]
    },
    "Georgia": {
        "first": ["Giorgi", "Lasha", "Levan", "Guram", "Merab", "Zurab", "Davit", "Nika", "Irakli", "Vakhtang",
                  "Tornike", "Shalva", "Mamuka", "Beka", "Temur", "Giga", "Avtandil", "Revaz", "Nodar", "Otar"],
        "last": ["Shavadze", "Topuria", "Dvalishvili", "Kutateladze", "Chikadze", "Tsarukyan", "Javakhishvili", "Gogoladze", "Kvaratskhelia", "Andronikashvili"]
    },
    "Argentina": {
        "first": ["Santiago", "Mateo", "Joaquin", "Benjamin", "Lucas", "Felipe", "Tomas", "Agustin", "Bruno", "Valentino",
                  "Thiago", "Bautista", "Lautaro", "Juan", "Martin", "Nicolas", "Franco", "Emiliano", "Facundo", "Maximiliano"],
        "last": ["Gonzalez", "Rodriguez", "Fernandez", "Lopez", "Martinez", "Garcia", "Sanchez", "Perez", "Romero", "Diaz",
                 "Alvarez", "Gomez", "Torres", "Ruiz", "Ramirez", "Herrera", "Castro", "Vargas", "Flores", "Silva"]
    },
}
