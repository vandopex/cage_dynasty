# CLAUDE.md ARCHIVE 2026B — C29-C46 shipping filings + AMP/MC-ODDS/FIGHT-MODEL/GENERATOR1 history

This file was created 2026-09-07 by ARCHIVE2. Its content was MOVED VERBATIM from CLAUDE.md at HEAD `62d3fc6` (C47); it was not summarized, reworded, or edited. Any change to this file is a defect.

Pointer back: CLAUDE.md carries in-place `<!-- ARCHIVE2 -->` markers where each moved block was, plus one summary line under § Archive pointing here. See CLAUDE.md at HEAD C47 or `git show 62d3fc6:CLAUDE.md` for the pre-split source-of-truth arrangement.
