...
- **WEEK-AXIS1** — (a) STAMP SHIPPED dcee687 (2026-09-10): live rows carry event_number parsed from their own event_name; T-4 202→0, name/number 1806/1806, pre-gen 0 diffs. (b) SEED UNBLOCKED 2026-09-10: R06 seam = 8 in 7/7 fresh runs (baseline, rerun, stamp, 2× uuid-pinned, 2× PYTHONHASHSEED=0) — the gate discriminates; post-fix gate is two fresh runs both seam 0 with pre-gen rows identical. (c) PREDICATE, (d) _recently_fought unchanged. Gate 0 filing `claude/week_axis1_gate0_2026-09-09.md`. FOUNDING-ROW2 open.
